...
#define I2CSTATE_TRYING   0x002	  /* If the state is lower than any of this we are IDLE */
...
#define I2SCLH_SCLH			8000 		/* I2C SCL Duty Cycle High Reg */
#define I2SCLL_SCLL			8000		/* I2C SCL Duty Cycle Low Reg */
